...
* [x] **[AI]** เขียน System Instruction ให้ `gemini-2.5-pro` สแกนหาความขัดแย้งทางตรรกะแบบวิพากษ์ (Critical Thinking)
...
* [x] **[AI]** ออกแบบ Prompt สั่งให้ Gemini เจนเนอเรต OpenAPI Specification ในรูปแบบ YAML / JSON
...
* [x] **[AI]** เขียนฟังก์ชันรวบรวมบริบทและจัดข้อมูลให้ออกมาเป็นตาราง 4 มิติ (Happy, Unhappy, Edge Case, RBAC)
...
* [ ] **[AI]** ใช้ `gemini-2.5-flash` แปลงหน้าตาโค้ดพังๆ สรุปออกมาเป็นคำแนะนำวิธีแก้ไขฉบับภาษาไทยเข้าใจง่าย
...
* [ ] **[AI]** ร่างโค้ดสร้าง Node การทำงานสำหรับฝั่งตรวจสอบ (SA Review -> QA -> DevOps -> PM)
* [ ] **[Human]** นำความคิดเห็น (Feedbacks) ของ AI มารวบรวมใส่ตัวแปรกลางเพื่อเตรียมแสดงผลบนหน้าแผงควบคุม
...
* [ ] **[Human]** เขียนคำสั่งระบุจุดหยุดพักขบวนการทำงาน (`interrupt_before`) ใน LangGraph เพื่อความปลอดภัยสูงสุด
* [ ] **[Human]** ติดตั้งจุดจัดเก็บสถานะระบบชั่วคราว (SqliteSaver หรือ Postgres Checkpointer) บน Server เพื่อรองรับการกดยืนยัน

### 📋 Task 4.2: Build Antigravity Governance Gateway Integration
* [ ] **[Human]** พัฒนาเส้นทางเชื่อมโยงข้อมูล (API Endpoint `/api/agent/review`) เพื่อรอรับคำสั่งส่งกลับมาจากมนุษย์
* [ ] **[AI]** ร่าง Prompt ปรับแต่งแต่งข้อความรายงานสรุปให้อ่านง่าย กระชับสั้นที่สุด เพื่อให้คนกดอนุมัติใน 10 วินาที
* [ ] **[Human]** ผูกปุ่มกดสั่งการ (Approve / Reject) บนหน้าจอระบบควบคุมภายนอกเพื่อให้สัญญาณรันต่อหรือตีกลับงาน